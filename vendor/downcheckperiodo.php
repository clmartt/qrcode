...
if($_GET['arquivo'] == 'preventiva'){
        ...
        $mysqli = new mysqli($host, $user, $pass, $db);
        $mysqli -> set_charset("utf8");
        $sqlchamado = "SELECT * FROM PREVENTIVAS where DATA_PREV BETWEEN '$dataInglesInicial' and '$dataInglesFinal' and PREDIO = '$predio' AND CLIENTE != 'EVENTOS' ORDER BY DATA_PREV";
