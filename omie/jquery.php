...
// ENVIANDO O PERIODO -------------------------------------------------------------------------------------------------
             ...
             $.get("periodo.php",{data:dataI,dataFim:dataF,stat:status},function(data){
...
//--------------------------------------------------------------------------------------------------------------
// ESSA PARTE É SOMENTE PARA O GRAFICO

$(document).on('click','.atualizar',function(){

// PEGANDO OS VALORES DAS EMPRESAS 

 var receberinfo = $("#receberresultadoinfo").text();
 var receberinfoint = parseInt(receberinfo.replace(/\D+/g, ""));
 alert(receberinfoint);
 var recebercom = parseFloat($("#receberresultadocom").text());
 var receberserv = parseFloat($("#receberresultadoserv").text());

 var pagarinfo = parseFloat($("#resultadoinfo").text());
 var pagarcom = parseFloat($("#resultadocom").text());
 var pagarserv = parseFloat($("#resultadoserv").text());
