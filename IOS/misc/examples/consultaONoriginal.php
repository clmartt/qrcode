                   ...
                   if($mysqli){
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<b><img src='./images/add.ico' id='busca_chamado' width=15 heigth=15>  QRCODE</b> : ".$row['QRCODE']."<BR>";
                                echo "<div id='resultado_chamado'><img src='./images/loading.gif'></div>";
                                echo '<hr>';
                                echo "<b>TIPO DE EQUIPAMENTO</b> : ".utf8_encode($row['TIPO_DE_EQUIPAMENTO'])."<BR>"; 
                                echo '<hr>';
                                echo "<b>CARACTERISTICA </b>: ".utf8_encode($row['CARACTERISTICA'])."<BR>";
                                echo '<hr>';
                                echo "<b>MARCA </b>: ".$row['MARCA']."<BR>";
                                echo '<hr>';
                                echo "<b>MODELO </b>: ".$row['MODELO']."<BR>";
                                echo '<hr>';
                                echo "<b>SERIE </b>: ".$row['N_SERIE']."<BR>";
                                echo '<hr>';
                                echo "<b>PREDIO </b>: ".$row['PREDIO']."<BR>";
                                echo '<hr>';
                                echo "<b>ANDAR </b>: ".$row['ANDAR']."<BR>";
                                echo '<hr>';
                                echo "<b>SETOR </b>: ".utf8_encode($row['SETOR'])."<BR>";
                                echo "<b>SALA </b>: ".utf8_encode($R_sala)."<BR>";
                                echo "<b>HORAS LAMP </b>: ".utf8_encode($row['HORAS_LAMP'])." - - > <img src='./images/atualizar.png' id='atualizar' width='30' heigth='30'><BR>";
                                echo '<hr>';
                        ...
                        <form action="insertcheck.php" method="POST" id="form_envia">
                            ...
                            <input type="hidden" id="R_setor" name="R_setor" value="<?php echo $R_setor?>">
                            ...
                            <div class="form-group" id="selecao">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" name="situacao">
                                 ...
                                 <BR>
                                <div id="divproblema">
                                <label for="exampleFormControlSelect1"><B>Problema</B></label>
                            ...
                            <div class="form-group green-border-focus" id="solucao">
                              <label for="exampleFormControlTextarea5"><B>Problema ou Solução Aplicada</B></label>
