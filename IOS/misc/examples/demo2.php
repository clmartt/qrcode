...
<nav class="navbar navbar-dark bg-dark">
 ...
 <p></p>
			...
			<div align="center">
			<div class="card text-white bg-secondary mb-3 w-80" style="width: 20rem;">

			  <div class="card-body">
			  	<VIDEO id="webcameraPreview" controls loop playsinline autoplay style ="WIDTH: 100%" muted></VIDEO>
    ...
    <form class="login100-form validate-form" action="consultaON.php" method="get">
                    ...
                    <input type="hidden" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon2" name="user" value="<?php echo $_SESSION['email']; ?>">
		                ...
		                <input type="text" class="form-control" placeholder="Digite QRCODE" aria-label="Digite QRCODE" aria-describedby="basic-addon2" name="qrcode" required="qrcode" id="qrcode" >
