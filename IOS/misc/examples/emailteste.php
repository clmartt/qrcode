...
$mailer->AddAddress('clmartt@gmail.com');//Destinatários freshservice@kvminformatica.com.br

$mailer->Subject = 'Convite Sistema ReQuest';

$mailer->Body = "Convite para o sistema ReQuest
Para realizar o Cadatro acesse : ". "https://kvm1000.websiteseguro.com/qrteste2/cadastro.php?email=".$email."&cliente=".$cliente."&perfil=".$perfil;
