...
echo "<script> alert('do insert')</script>";
// Conectando 
try { 
...
$stmt = $pdo->prepare("INSERT INTO CHAMADOS(string_id,horas,data_2,mes,ano,qrcode,ativo,modelo,marca,predio,andar,sala,situacao,observacao,nome_user,status,serie,horas_lamp) 
values ('$R_string_id','$horas','$data_2','$mes','$ano','$R_qrcode','$R_ativo','$R_modelo','$R_marca','$R_predio','$R_andar','$R_sala','$R_situacao','$R_info','$R_usuario_post','$R_status','$R_serie','$R_horaLamp')"); 
