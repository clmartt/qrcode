      ...
      echo'<div class="card">';
        echo '<div class="card-header" id="'.$res2['ID_REGISTRO'].'">';
         ...
         echo '<div class="card-body" id="form'.$res2['ID_REGISTRO'].'">';
          echo '<h5 class="card-title">'.$res2['QRCODE'].' | '.utf8_encode($res2['TIPO_DE_EQUIPAMENTO']).'</h5>';
          ...
          $('.checado').click(function(){
           ...
           $(this).off('click');
             ...
             $(document).on('click', 'a', function(){
                ...
                var nomeIdform2 = "#form"+idchamado;
                $(nomeIdform2).empty();
