...
$stmt = $pdo->prepare("UPDATE QRCODETABLE SET HORAS_LAMP = '$hora_nova' WHERE QRCODE LIKE '%$N_qrcode%' "); 
...
if ($stmt) { 
echo 'ATUALIZADO!!!';
echo "<script>alert('vim do update')</script>";
...
echo "<script>alert('errroooooooooo')</script>";
