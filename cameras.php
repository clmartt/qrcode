	...
	<div  >
		...
		<div align="center">
					...
					<div class="card" style="width: 15rem;">
						  <img class="card-img-top" src="./images/qrcodescan.gif" alt="Card image cap">
						  <div class="card-body">
						    
						   
						    <p></p>
						    <a href="https://kvm1000.websiteseguro.com/qrteste2/IOS/misc/examples/camsala.php?user=<?php echo $_SESSION['email'] ?>" class="btn btn-primary">Check List</a>
						  </div>
						  <div class="card-body">
						    <a href="https://kvm1000.websiteseguro.com/qrteste2/IOS/misc/examples/demo.php?user=<?php echo $_SESSION['email'] ?>" class="btn btn-primary">Preventiva</a>
						  </div>
					</div>
