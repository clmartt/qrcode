    ...
    <script>
        $(document).ready(function(){
            ...
            $("#buscar").click(function(){
                ...
                $.post('buscaAtividadeadm.php',{atividade:ativ,situacao:sit,usuarios:usuario,clientes:cliente},function(data){
                    $("#retorno").empty();
                    $("#retorno").append(data);
            ...
            $(document).on('click','#excluir',function(){
                var confirmar = confirm("Deseja mesmo excluir");
                if(confirmar){
                    var idAtividades = $(this).val();
